...
| `NEXT_PUBLIC_APP_URL` | Yes | Public URL of your app. Use `http://127.0.0.1:3000` for local dev. |
...
For local development, see [references/local-development.md](references/local-development.md).
